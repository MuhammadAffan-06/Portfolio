...
export default function Introduction() {
    return (
        <>
            <div className="grid grid-rows-2 mt-20 justify-items-center md:grid-cols-2 text-white" style={{ fontFamily: 'Manrope' }}>
                ...
                <section className="relative flex justify-center items-center">
                    ...
                    <div className="relative z-10 flex flex-col items-center">
                        <h1 className="text-3xl font-bold text-center md:text-4xl mb-4">Muhammad Affan</h1>
                        <Profilepicture />
                    </div>
                </section>
                    ...
                    <section className="flex md:grid grid-cols-1 md:grid-cols-2 justify-center gap-8 w-full">
                        ...
                        <div className="text-sm md:text-base text-center md:text-left flex flex-col justify-center gap-4 text-white">
                            ...
                            <div className="flex flex-col md:flex-row gap-4 justify-center md:justify-start items-center">
                                <Button className="hidden md:inline-block bg-[#4A2CED] hover:bg-[#3722bd] text-white">Let's Work</Button>
                                <Button className="bg-white text-black hover:bg-gray-300">Download CV</Button>
                            </div>
                        </div>
                    </section>
                </section>
